...
%>  
   <tr class="tr04001">
    <td class="td014CC001" style="width:2%">&nbsp;</td>   
<%
...
%>
   ...
   <tr class="tr00001"> 
    <td class="td044CC002" style="<%= dependentStyle %>">&nbsp;</td>   
<%
...
%>    
    <td class="td044CL002">
      <%= HTMLHelpersLinks.basicLink(thisrow.getDescription(), thisrow.getProcessDocument(), "", "", "") %>
    </td>
    <td class="td044CC002">
<%
   if (mainReadOnlyR.equals("N"))
      imageCountR++;
%>    
     <%= HTMLHelpersInput.inputBoxDate(("targetDate" + cntR), thisrow.getTargetDate(), ("dd" + cntR), "N", mainReadOnlyR) %>
    </td>
    <td class="td044CC002">
<%  
   if (thisrow.getStatus().toLowerCase().equals("complete"))
...
%>    
     <a class="a04002" href="<%= dependenciesLink.toString() %>" title="Click here to see all dependecies associated to this Function, AND the status of each." target = "_blank"><%= dependency %></a>
    </td>  
