	...
	<table class="styled full-width">
	   ...
	   <colgroup>
        ...
        <tr>
            ...
            <th title="Only Bins will be Entered, whole numbers, Pounds and Tons will be calculated if needed">
                Available
            </th>
        </tr>
...
<%-- End form tag located in updAvailFruitToPurchaseByWhse.jsp --%>