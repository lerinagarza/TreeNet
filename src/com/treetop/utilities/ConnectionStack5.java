	...
	throws java.sql.SQLException 
{
	...
	if (connStack == null)
	{
		...
		//	Connection c = DriverManager.getConnection("jdbc:as400://10.6.100.3", "TNCON5", "tncon5");
			Connection c = DriverManager.getConnection("jdbc:as400://lawson.treetop.com", "TNCON5", "tncon5");
			connStack.push(c);
		}
	}
}
...
public static synchronized void closeAllConnections() {
    ...
    while (!connStack.empty()) {
       try {
          ...
          System.out.println("Error @ com.treetop.utilities.ConnectionStack5.closeAllConnections(): " + e);
       }
    }      	
}
/**
 ...
 */
  public static synchronized Connection getConnection() {
	  ...
	  {	
		  ...
		  ConnectionStack5 init = new ConnectionStack5();
  		
		  //get connection
		  if (connStack.empty()) {
			  //log the error and return a null connection.
			  System.out.println("Error @ com.treetop.utilities.ConnectionStack5.getConnection(): ");
		  ...
		  System.out.println("Error @ com.treetop.utilities.ConnectionStack5.getConnection(): " + e);
	  }
 ...
 */
  public static synchronized void returnConnection(Connection c) {
	...
	{
  		System.out.println("Error @ com.treetop.utilities.ConnectionStack5.returnConnection(): " + e);
  		e.printStackTrace();
	}	
  }
