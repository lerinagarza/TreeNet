...
public class ConnectionStack8 {
	...
	static {
		try {
			...
			System.out.println("com.treetop.ConnectionStack8 - missing driver. " + e); 
		}
	}
	...
	throws java.sql.SQLException 
{
	...
	if (connStack == null)
	{
		...
		//		"jdbc:as400://10.6.100.3", "TNCON8", "tncon8");
			Connection c = DriverManager.getConnection(
					"jdbc:as400://lawson.treetop.com", "TNCON8", "tncon8");
			connStack.push(c);
		}
	}
}
...
public static synchronized void closeAllConnections() {
    ...
    while (!connStack.empty()) {
       try {
          ...
          System.out.println("Error @ com.treetop.utilities.ConnectionStack8.closeAllConnections(): " + e);
       }
    }      	
}
/**
 ...
 */
  public static synchronized Connection getConnection() {
	  ...
	  {	
		  ...
		  ConnectionStack8 init = new ConnectionStack8();
  		
		  //get connection
		  if (connStack.empty()) {
			  //log the error and return a null connection.
			  System.out.println("Error @ com.treetop.utilities.ConnectionStack8.getConnection(): ");
		  ...
		  System.out.println("Error @ com.treetop.utilities.ConnectionStack8.getConnection(): " + e);
	  }
 ...
 */
  public static synchronized void returnConnection(Connection c) {
	...
	{
  		System.out.println("Error @ com.treetop.utilities.ConnectionStack8.returnConnection(): " + e);
  		e.printStackTrace();
	}	
  }
